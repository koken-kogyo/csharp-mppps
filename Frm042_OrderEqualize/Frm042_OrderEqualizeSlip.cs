...
namespace MPPPS
{
    public partial class Frm042_OrderEqualize
    {
        ...
        private void Cbx_McCd_LostFocus(object sender, EventArgs e)
        {
            ...
            // 後続コントロール初期化
            InitSubseqCtrls((int)Common.Frm042InqKeyIdx.McOnTime);
        }
        ...
        private void InitSubseqCtrls(int pKeyNo)
        {
            ...
            if (pKeyNo <= (int)Common.Frm042InqKeyIdx.EdDt) // 手配日付
            {
                // グループ
            ...
            if (pKeyNo <= (int)Common.Frm042InqKeyIdx.McGCd) // グループ
            {
                // 設備
            ...
            if (pKeyNo <= (int)Common.Frm042InqKeyIdx.McCd) // 設備コード
            {
                // 設備稼働時間
            ...
            if (pKeyNo <= (int)Common.Frm042InqKeyIdx.McOnTime) // 設備稼働時間
            {
                // 切削オーダー データ (現在)
